...
export function BaseCard({ baseId, baseName }: BaseCardProps) {
  return (
    <Link href={`/base?baseId=${baseId}`} className="flex flex-auto items-center gap-4 rounded-md border border-gray-300 bg-white p-4 shadow-sm hover:shadow-md">
